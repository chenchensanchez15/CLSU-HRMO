            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" name="first_name" class="w-full border rounded-md px-2 py-1.5 focus:ring-2 focus:ring-clsuGreen focus:outline-none" placeholder="Enter your first name" required>
                    </div>
                    <div>
                        <label class="block text-xs font-medium mb-1">Middle Name</label>
                        <input type="text" name="middle_name" class="w-full border rounded-md px-2 py-1.5 focus:ring-2 focus:ring-clsuGreen focus:outline-none" placeholder="Enter your middle name">
                    </div>
                    <div>
                        <label class="block text-xs font-medium mb-1">Last Name</label>
                        <input type="text" name="last_name" class="w-full border rounded-md px-2 py-1.5 focus:ring-2 focus:ring-clsuGreen focus:outline-none" placeholder="Enter your suname" required>
                    </div>
                    <div>
